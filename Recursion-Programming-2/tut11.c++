// Question -> Source to Destination allowed only two moves Right or UP
...
{
    int m, n;
    cout << "Enter the value of m & n for m*n matrix: ";
    cin >> m >> n;

    int src_x, src_y;
    cout << "Enter the Origin Co-ordinates: ";
    cin >> src_x >> src_y;

    int dest_x, dest_y;
    cout << "Enter the Destination Co-ordinates: ";
    cin >> dest_x >> dest_y;
